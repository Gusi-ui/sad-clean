-- ============================================================================
-- SAD LAS - SISTEMA COMPLETO DE ASIGNACIONES Y FESTIVOS
-- ============================================================================
-- Script completo para crear tablas y datos de prueba
-- ============================================================================
...
SELECT
    ...
    COUNT(*) FILTER (WHERE status = 'inactive') as inactive_assignments,
    COUNT(*) FILTER (WHERE status = 'completed') as completed_assignments,
    AVG(weekly_hours) as average_weekly_hours
FROM assignments;
