-- ============================================================================
-- SAD LAS - CONFIGURACIÓN COMPLETA DEL SISTEMA
-- ============================================================================
-- Script completo que verifica, crea tablas e inserta datos
-- ============================================================================
...
SELECT 'Tabla holidays creada correctamente' as status
WHERE EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'holidays')
UNION ALL
SELECT 'Tabla assignments creada correctamente' as status
WHERE EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'assignments');
