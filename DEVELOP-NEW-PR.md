...
**Rama origen:** `develop-new` **Rama destino:** `main` **Tipo:** `feat` (Nueva funcionalidad)
...
Implementación de mejoras significativas para el dashboard de trabajadoras, incluyendo vista mensual
tipo planning, mejoras en balances, correcciones técnicas y optimizaciones de UX.
...
Implementación de mejoras significativas para el dashboard de trabajadoras, incluyendo vista mensual
tipo planning, mejoras en balances y correcciones técnicas.
...
_Este PR contiene mejoras valiosas para el dashboard de trabajadoras y correcciones técnicas
importantes._ 🚀✅
