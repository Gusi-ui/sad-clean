...
**Rama origen:** `develop/feature-updates`  
**Rama destino:** `main`  
...
Implementación completa del sistema de gestión de vacaciones para el sistema SAD LAS, incluyendo API endpoints, interfaz de usuario, scripts de utilidad y documentación completa.
...
**Rama:** `develop/feature-updates`

---

*Este PR está listo para revisión y merge a la rama principal.* 🚀
